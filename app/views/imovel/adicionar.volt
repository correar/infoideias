...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12">
			{{ form("imoveis/cadastrar", "method": "post", 'enctype': 'multipart/form-data') }}
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
					...
					<div class="form-group" id="vvenda" style="display:none">
						...
						{{ text_field("valor_venda", "size": 20) }}
					</div>
					<div class="form-group" id="valuguel" style="display:none">
						...
						{{ text_field("valor_aluguel", "size": 20) }}
					</div>
                </div>
            </div>
